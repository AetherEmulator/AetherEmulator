...
git init
git branch -M main
git remote add origin https://github.com/AetherEmulator/AetherEmulator
git remote set-url --push origin https://AetherEmulator:{main_github_token}@github.com/AetherEmulator/AetherEmulator
